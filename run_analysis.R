...
test_data_all <- cbind(Y_test_data,X_test_data)
setnames(test_data_all,"V1","activity")
...
train_data_all <- cbind(Y_train_data,X_train_data)
setnames(train_data_all,"V1","activity")
